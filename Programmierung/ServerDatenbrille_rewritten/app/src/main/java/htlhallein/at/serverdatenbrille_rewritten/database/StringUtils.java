...
/**
 * @author Gnawer from StackOverflow.com
 * @link http://stackoverflow.com/questions/994331/java-how-to-decode-html-character
 * -entities-in-java-like-httputility-htmldecode
 */
...
public class StringUtils {
    ...
    private static final String[][] ESCAPES = {{"\"", "quot"}, // " -
            // double-quote
            {"&", "amp"}, // & - ampersand
            {"<", "lt"}, // < - less-than
            {">", "gt"}, // > - greater-than
